// Error boundary and file upload progress
...
// Lifecycle method updates state when a childthrows an error during rendering
...
function UploadComponent(){
    ...
    return(
        <section>
            <h2>File upload and error boundaries</h2>
            <button onClick={startUpload} disabled={isUploading}>{isUploading?"Uploading...":"Upload file"}</button>
            <button onClick={resetUpload} disabled={isUploading && progress === 0}>Reset</button>
